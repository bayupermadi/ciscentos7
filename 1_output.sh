...
echo "1.6.1.2, Ensure the SELinux state is enforcing (Scored). $check1_6_1_2"
echo "1.6.1.4, Ensure SETroubleshoot is not installed (Scored), $check1_6_1_4"
echo "1.6.1.5, Ensure the MCS Translation Service (mcstrans) is not installed (Scored), $check1_6_1_5"
echo "1.6.1.6, Ensure no unconfined daemons exist (Scored), $check1_6_1_6"